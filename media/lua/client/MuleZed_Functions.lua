...
function MuleZed.setRandWalk(zed)
	zed:setWalkType(tostring(ZombRand(1,6)));
end


function MuleZed.findID(int)
...
function MuleZed.getDist(zed, targ)
...
function MuleZed.pause(seconds, callback)
