...
function MuleZed.follow(pl)
	if not pl or not MuleZed.muleObjSq then return end
	local csq = pl:getCurrentSquare()
	if not csq then return end
	MuleZed.stepCont(MuleZed.muleObjSq, csq)
